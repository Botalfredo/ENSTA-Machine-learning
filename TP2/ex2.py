...
print('Expected gradients (approx): -0.1000 -12.00921659 -11.26284221')
...
print('Expected gradients (approx): 0.04290299 2.56623412 2.64679737')
...
print('Expected cost (approx): 0.203498')
print('\n -------------------------- \n')
print('theta:', ["%0.4f" % i for i in theta])
print('Expected theta (approx): -25.1613 0.206 0.201')
...
print('Expected Proba (approx): 0.776291')
